...
- link:https://github.com/downloads/networkupstools/wmnut/wmnut-0.68.tar.gz[wmnut-0.68.tar.gz]
...
NOTE: For FreeBSD and OpenIndiana users, the default BSD `make` or Sun `dmake`
programs respectively in modern releases (2020's) do also work for the simple
recipes used here; however in case of `Makefile` syntax problems -- remember
to try using `gmake` instead!
...
WMNut is Copyright (C) 2002 - 2020 link:http://arnaud.quette.free.fr/contact.html[Arnaud Quette]

WMNut is Copyright (C) 2021 - 2023 by the Network UPS Tools project
