...
system supporting X11. Like NUT, it may require C99 or newer compiler support.
...
- NUT client library, version 2.8.0 or higher (may work with 2.2.1 or higher at expense of build warnings).
  For example on a Debian GNU/Linux system, you need to install the package `libupsclient-dev` (note that
  some stable distributions still ship NUT v2.7.4 based packages!)
